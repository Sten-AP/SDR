...
class Labo_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._a3_range = Range(-5, 5, 0.001, 1, 200)
        ...
        self._a2_range = Range(-5, 5, 0.001, 1, 200)
        ...
        self._a1_range = Range(-5, 5, 0.001, 1, 200)
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_fff(1, [a1 - a2 -a3])
        ...
        # Connections
        ##################################################
        self.connect((self.analog_noise_source_x_0, 0), (self.fir_filter_xxx_0, 0))
    ...
    def set_a3(self, a3):
        self.a3 = a3
        self.fir_filter_xxx_0.set_taps([self.a1 - self.a2 -self.a3])
