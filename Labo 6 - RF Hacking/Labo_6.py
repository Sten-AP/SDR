...
class Labo_6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(1-chkbox)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(chkbox)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 5000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, -5000, 1, 0, 0)
    ...
    def set_chkbox(self, chkbox):
        self.chkbox = chkbox
        self._chkbox_callback(self.chkbox)
        self.blocks_multiply_const_vxx_0.set_k(self.chkbox)
        self.blocks_multiply_const_vxx_0_0.set_k(1-self.chkbox)
