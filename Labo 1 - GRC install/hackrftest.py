...
class hackrftest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "hackrftest", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("hackrftest")
        ...
        self.settings = Qt.QSettings("GNU Radio", "hackrftest")
        ...
        self.soapy_hackrf_source_0.set_frequency(0, 446.000e6)
